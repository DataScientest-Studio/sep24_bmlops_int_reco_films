...
def get_next_version():
    ...
    existing_files = glob.glob('workflow_diagrams/mlops_workflow_v*.png')
...
def create_mlops_workflow_v2():
    ...
    dot = Digraph(comment='MLOps Workflow Detailed', 
                  graph_attr={
                      'rankdir': 'TB',
                      'size': '18,14!',
                      'dpi': '300',
    ...
    with dot.subgraph(name='cluster_0') as c:
        c.attr(label='1. CI/CD Pipeline (GitHub Actions)',
              style='filled',
              color='#E8E8E8',
              bgcolor='#F5F5F5',
        ...
        c.node('update_version', '📊\nVersion Control\n- Update Data Version\n- Log Changes\n(Step 2)',
               fillcolor='white')
        c.node('trigger_pipeline', '🚀\nPipeline Trigger\n- Start DVC Pipeline\n- Check Dependencies\n(Step 3)',
               fillcolor='white')
        c.node('push_main', '⬆️\nRepository Update\n- Push Changes\n- Update Main\n(Step 4)',
               fillcolor='white')
        c.node('deploy_api', '🔄\nDeployment\n- Update API\n- Health Check\n(Step 5)',
    ...
    with dot.subgraph(name='cluster_1') as c:
        c.attr(label='2. DVC Pipeline (MLFlow/DVC)',
              style='filled',
              color='#FFF8DC',
              bgcolor='#FFFACD',
              fontname='Helvetica-Bold',
        ...
        c.node('append_data', '📥\nData Pipeline\n- Append New Data\n- Process Updates\n(Step 6)',
               fillcolor='white')
        c.node('validate_data', '✅\nValidation\n- Quality Checks\n- Schema Validation\n(Step 7)',
               fillcolor='white')
        c.node('transform_data', '⚙️\nTransformation\n- Feature Engineering\n- Data Prep\n(Step 8)',
               fillcolor='white')
        c.node('train_model', '🧠\nModel Training\n- Algorithm Update\n- Parameter Tuning\n(Step 9)',
               fillcolor='white')
        c.node('evaluate_model', '📈\nEvaluation\n- Performance Metrics\n- Quality Check\n(Step 10)',
               fillcolor='white')

    with dot.subgraph(name='cluster_2') as c:
        c.attr(label='3. Experiment Monitoring',
              style='filled',
              color='#E6F3FF',
              bgcolor='#F0F8FF',
              fontname='Helvetica-Bold',
              fontsize='16',
              margin='20')
        c.node('mlflow_registry', '📚\nMLFlow Registry\n- Track Experiments\n- Store Results\n(Step 11)',
               fillcolor='white')
        c.node('dvc_version', '💾\nDVC Version\n- Data Versioning\n- Model Tracking\n(Step 12)',
               fillcolor='white')

    with dot.subgraph(name='cluster_3') as c:
        c.attr(label='4. Deployed Application',
              style='filled',
              color='#E0FFE0',
              bgcolor='#F0FFF0',
              fontname='Helvetica-Bold',
        ...
        c.node('new_api', '🌟\nAPI Service\n- New Version\n- Endpoints Update\n(Step 13)',
               fillcolor='white')
        c.node('user_interaction', '👥\nUser Interface\n- Recommendations\n- Feedback\n(Step 14)',
               fillcolor='white')

    with dot.subgraph(name='cluster_4') as c:
        c.attr(label='5. Monitoring Stack',
              style='filled',
              color='#FFE6E6',
              bgcolor='#FFF0F0',
              fontname='Helvetica-Bold',
    ...
    edges = [
        ('cron', 'update_version', '1️⃣ Schedule → Version\n- Daily Trigger\n- Version Check'),
        ('update_version', 'trigger_pipeline', '2️⃣ Version → Pipeline\n- Start Process\n- Validate'),
    ...
    for src, dst, label in edges:
        dot.edge(src, dst, label, minlen='2', 
                fontsize='11',
                labelangle='45',
                labeldistance='2.0')
    ...
    with dot.subgraph(name='cluster_legend') as legend:
        legend.attr(label='🔍 Pipeline Components & Flow',
                   style='filled',
                   color='white',
                   fontsize='16')
        legend.node('l1', '🔄 CI/CD Pipeline\nAutomated Deployment',
                   style='filled', fillcolor='#F5F5F5')
        legend.node('l2', '📊 Data Pipeline\nProcessing & Training',
                   style='filled', fillcolor='#FFFACD')
        legend.node('l3', '🚀 API Service\nUser Interface',
                   style='filled', fillcolor='#F0FFF0')
        legend.node('l4', '📈 Monitoring\nMetrics & Alerts',
...
if __name__ == "__main__":
    try:
        ...
        output_base = f'workflow_diagrams/mlops_workflow_v{version}'
        ...
        import shutil
        shutil.copy(f'{output_base}.png', 'workflow_diagrams/mlops_workflow_latest.png')
        shutil.copy(f'{output_base}.svg', 'workflow_diagrams/mlops_workflow_latest.svg')
